...
class CSlangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by CSlangParser#stmt1.
    ...
    # Visit a parse tree produced by CSlangParser#varstmt_list.
    def visitVarstmt_list(self, ctx:CSlangParser.Varstmt_listContext):
        return self.visitChildren(ctx)
